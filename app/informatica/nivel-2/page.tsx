...
const computerParts: MatchPair[] = [
  { id: 1, part: 'Monitor', emoji: '🖥️', description: 'Afișează imaginile și textul' },
  { id: 2, part: 'Tastatură', emoji: '⌨️', description: 'Introducem text și comenzi' },
  { id: 3, part: 'Mouse', emoji: '🖱️', description: 'Mutăm cursorul pe ecran' },
  { id: 4, part: 'Unitate Sistem', emoji: '🖲️', description: 'Creierul computerului' },
  { id: 5, part: 'Imprimantă', emoji: '🖨️', description: 'Tipărește documente' },
  { id: 6, part: 'Boxe', emoji: '🔊', description: 'Redau sunetele' },
];
...
export default function InformaticaNivel2() {
  ...
  const shuffledDescriptions = [...computerParts].sort(() => Math.random() - 0.5);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-400 via-cyan-400 to-blue-500 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-2xl text-blue-600 mb-6">
            Ai potrivit toate părțile computerului!
          </p>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Părțile Computerului
          </h1>
          <p className="text-xl text-blue-100">
            Potrivește fiecare parte cu descrierea sa!
          </p>
          <div className="mt-4 inline-block bg-white/90 backdrop-blur-sm rounded-full px-6 py-3">
            <span className="text-lg font-bold text-blue-800">
              Potriviri: {matched.length}/{computerParts.length}
            </span>
          </div>
        </motion.div>
        ...
        {showFeedback && (
          ...
          >
            {showFeedback === 'correct' ? '✅ Corect!' : '❌ Încearcă din nou!'}
          </motion.div>
        )}
