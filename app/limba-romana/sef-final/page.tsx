        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-green-400 text-sm">Tu</p>
            </div>

            <div className="text-4xl font-black text-[#E8A33D]">VS</div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#F0F4E5] font-bold text-xl mt-2">Vulpea Vicleană</p>
              <p className="text-red-400 text-sm">Adversar</p>
            </div>
          </motion.div>
          ...
          >
            <p className="text-[#612422] font-bold">
              🎯 Răspunde corect la întrebări despre limba română!<br/>
              ⏱️ Ai 10 secunde pentru fiecare întrebare.<br/>
              🏆 Primul care ajunge la mai multe puncte câștigă!
            </p>
          </motion.div>
      ...
      >
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4">
          ...
          >
            {playerWon ? (
              <>
                <h1 className="text-5xl md:text-7xl font-black text-[#F0F4E5] mb-4">🏆 VICTORIE!</h1>
                <p className="text-2xl text-[#E8A33D] font-bold">Felicitări! Ai învins Vulpea Vicleană!</p>
              </>
            ) : isDraw ? (
              <>
                <h1 className="text-5xl md:text-7xl font-black text-[#F0F4E5] mb-4">🤝 EGALITATE!</h1>
                <p className="text-2xl text-[#E8A33D] font-bold">O luptă strânsă! Încearcă din nou!</p>
              </>
            ) : (
              <>
                <h1 className="text-5xl md:text-7xl font-black text-[#F0F4E5] mb-4">😔 ÎNFRÂNGERE</h1>
                <p className="text-2xl text-[#E8A33D] font-bold">Vulpea a câștigat! Mai încearcă!</p>
              </>
            )}
          </motion.div>
          ...
          >
            ...
            <div className="text-3xl font-black text-[#E8A33D]">VS</div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#F0F4E5] font-bold">Vulpea</p>
            </div>
          </motion.div>
