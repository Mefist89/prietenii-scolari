        ...
        >
          ...
          <ul className="text-lg text-gray-700 space-y-3">
            <li className="flex items-center gap-3">
              ...
              Apare un numar in caseta portocalie
            </li>
            <li className="flex items-center gap-3">
              <span className="text-2xl">🔍</span>
              Gaseste expresia care da acest rezultat
            </li>
            <li className="flex items-center gap-3">
              <span className="text-2xl">⏱️</span>
              Ai <span className="font-bold text-red-600">10 secunde</span> sa raspunzi!
            </li>
            <li className="flex items-center gap-3">
              <span className="text-2xl">🐝</span>
              Sting raspunde in <span className="font-bold text-orange-600">10 secunde</span> - fii rapid!
            </li>
            <li className="flex items-center gap-3">
              <span className="text-2xl">🏆</span>
              Primul care raspunde corect castiga punctul
            </li>
          </ul>
        </motion.div>
