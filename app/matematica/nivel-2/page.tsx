      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12">
          <div className="text-center mb-8">
            ...
            <h1 className="text-5xl font-bold text-yellow-800 mb-2">Nivel 2</h1>
            <p className="text-2xl text-yellow-600">Scăderi Simple</p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-yellow-100 p-6 rounded-xl">
              ...
              <p className="text-lg text-gray-700">
                Acum vei învăța să scazi numere mici. Este ca și cum ai lua lucruri dintr-o grămadă!
              </p>
            </div>
            ...
            <div className="border-4 border-yellow-300 p-6 rounded-xl">
              ...
              <p className="text-2xl text-gray-800 mb-6">8 - 3 = ?</p>
            ...
            <div className="border-4 border-yellow-300 p-6 rounded-xl">
              ...
              <p className="text-2xl text-gray-800 mb-6">10 - 4 = ?</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <button className="bg-yellow-200 hover:bg-yellow-300 p-4 rounded-lg font-bold text-xl transition-colors">
                  5
                </button>
            ...
            <div className="border-4 border-yellow-300 p-6 rounded-xl">
              ...
              <p className="text-2xl text-gray-800 mb-6">7 - 2 = ?</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <button className="bg-yellow-200 hover:bg-yellow-300 p-4 rounded-lg font-bold text-xl transition-colors">
                  3
                </button>
