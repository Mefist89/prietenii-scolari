        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#E67E3B] mb-2">{t('Math.level3.title')}</h1>
              <p className="text-xl md:text-2xl text-[#8B7355]">{t('Math.level3.subtitle')}</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#FFF3D6] p-6 rounded-xl border-2 border-[#F4D35E]">
                ...
                <p className="text-lg text-gray-700">
                  {t('Math.level3.description')}
                </p>
              </div>

              {/* Exercițiul 1 */}
              <div className="bg-[#E8F4F8] p-8 rounded-2xl border-4 border-[#95C9DD]">
                <h3 className="text-2xl font-bold text-[#5A8FA8] mb-6">{t('Common.exercise')} 1</h3>
              ...
              <div className="bg-[#F5E8F5] p-8 rounded-2xl border-4 border-[#D4A5D4]">
                <h3 className="text-2xl font-bold text-[#9B6B9B] mb-6">{t('Common.exercise')} 2</h3>
              ...
              <div className="bg-[#E8F5E8] p-8 rounded-2xl border-4 border-[#A8D5A8]">
                <h3 className="text-2xl font-bold text-[#5A9C5C] mb-6">{t('Common.exercise')} 3: {t('Math.level3.ballGame')}</h3>
                ...
                {ex3CurrentIndex < exercises3Data.length ? (
                  <div className="bg-white p-8 rounded-xl shadow-md">
                    ...
                    <div className="mb-6 text-center">
                      <p className="text-xl font-bold text-gray-700">
                        {t('Common.level')} {ex3CurrentIndex + 1} {t('Common.levelOf')} {exercises3Data.length}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8 bg-[#8B7355] p-6 rounded-xl">
                      ...
                      >
                        <div className="text-center mb-4">
                          <span className="text-3xl font-bold text-gray-800">{t('Math.level3.tens')}</span>
                        </div>
                        ...
                        <p className="text-center mt-2 text-sm text-gray-600">{t('Math.level3.dragHere')}</p>
                      </div>
                      ...
                      >
                        <div className="text-center mb-4">
                          <span className="text-3xl font-bold text-gray-800">{t('Math.level3.ones')}</span>
                        </div>
                        <div className="flex flex-wrap gap-2 justify-center min-h-[100px]">
                    ...
                    <div className="bg-gradient-to-r from-[#8B7355] to-[#6B5345] p-6 rounded-xl border-4 border-gray-800">
                      <p className="text-center text-2xl font-bold text-white mb-4">{t('Math.level3.ballBox')}</p>
                      <p className="text-center text-lg text-white/90 mb-4">{t('Math.level3.dragToTable')}</p>
                    ...
                    {!isChecked && (
                      <div className="mt-6 text-center">
                        ...
                        >
                          {t('Math.level3Extra.checkAnswer')}
                        </button>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-md text-center">
                    ...
                    <h3 className="text-3xl font-bold text-[#5A9C5C] mb-4">
                      {t('Common.congratulations')} {t('Common.completedAllLevels')}
                    </h3>
                    <p className="text-xl text-gray-700">
                      {t('Common.pressToSeeResults')}
                    </p>
                  </div>
                )}
              </div>
          ...
          `}>
            <div className="text-center">
              ...
              <h3 className={`text-3xl font-bold mb-4 ${
                ...
                {feedbackType === 'correct' && t('Common.correct')}
                {feedbackType === 'partial' && t('Common.almost')}
                {feedbackType === 'incorrect' && t('Common.tryAgain')}
              </h3>

              <p className="text-xl text-gray-700">
                {feedbackType === 'correct' && t('Math.level3Extra.goToNextLevel')}
                {feedbackType === 'partial' && t('Common.checkAgain')}
                {feedbackType === 'incorrect' && t('Common.countCorrectly')}
              </p>
