    ...
    >
      ...
      >
          ...
          <>
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">
                {t('Math.finalBossGame.winCongrats')}
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              {t('Math.finalBossGame.winMessage')}
            </p>
          </>
        ) : tie ? (
          <>
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-yellow-500 to-orange-500 bg-clip-text text-transparent">
                {t('Math.finalBossGame.tie')}
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              {t('Math.finalBossGame.tieMessage')}
            </p>
          </>
        ) : (
          <>
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4">
              <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">
                {t('Math.finalBossGame.stingWon')}
              </span>
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              {t('Math.finalBossGame.loseMessage')}
            </p>
          </>
        )}
        ...
        >
          ...
          >
            {t('Math.finalBossGame.playAgain')}
          </motion.button>
        </motion.div>
      </motion.div>
    </div>
