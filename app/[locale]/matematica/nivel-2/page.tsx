        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#E67E3B] mb-2">{t('Math.level2.title')}</h1>
              <p className="text-xl md:text-2xl text-[#8B7355]">{t('Math.level2.subtitle')}</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#E8F5E8] p-8 rounded-2xl border-4 border-[#A8D5A8]">
                <h3 className="text-2xl font-bold text-[#5A9C5C] mb-6">{t('Common.exercise')} 3</h3>
