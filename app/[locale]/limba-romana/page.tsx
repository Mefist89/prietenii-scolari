      ...
      <div className="absolute top-4 right-4 z-20">
        <Link href="/limba-romana/menu">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-2 bg-white/80 hover:bg-white text-[#4A6E3C] font-bold rounded-full shadow-lg backdrop-blur-sm transition-all"
          >
            {t("Common.skip")} →
          </motion.button>
        </Link>
                ...
                {showText && (
                  ...
                  >
                    ...
                    <div className="bg-[#F0F4E5] rounded-3xl px-8 py-6 shadow-2xl border-4 border-[#4A6E3C] max-w-md">
                      ...
                      <TypewriterText
                        text={t("Romanian.intro.greeting")}
                        delay={300}
